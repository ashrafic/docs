...
The Auto-Translation Agent is a background monitor that detects untranslated strings and automatically queues machine translation jobs. Set it up once, and your translations stay current without manual intervention.
