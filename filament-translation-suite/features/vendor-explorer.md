...
Laravel packages ship with their own translation files. When you install a package like Laravel Cashier, Spark, or Filament itself, those translations live in the package's `resources/lang` directory — not yours.

The Vendor Explorer lets you browse, review, and override vendor translations without touching the package source code.
